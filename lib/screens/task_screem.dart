...
import 'package:flutter_app/widgets/CardTaskWidget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ValueListenableBuilder(
        valueListenable: GlobalValues.flagTask,//valor que va estar monitoreando
...
//que hace el fture builder consume un future y retorna el widget 